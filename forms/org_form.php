<fieldset>
    <div class="form-group">
        <label for="f_name">Organization Name</label>
          <input type="text" name="orgname" value="<?php echo htmlspecialchars($edit ? $customer['f_name'] : '', ENT_QUOTES, 'UTF-8'); ?>" placeholder="First Name" class="form-control" required="required" id = "f_name" >
    </div> 
